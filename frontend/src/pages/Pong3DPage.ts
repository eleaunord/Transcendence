...
// export function createPong3DPage(navigate: (path: string) => void, /*mode: 'local' | 'ai'*/): HTMLElement {
//    const container = document.createElement('div');
...
//   // const gameFrame = document.createElement('div');
//   // gameFrame.className = 'relative w-full h-full bg-black overflow-hidden';
//   // gameFrame.appendChild(canvas);

//   // const scoreBoard = document.createElement("div");
//   // scoreBoard.id = "scoreBoard";
//   // scoreBoard.className = "absolute top-6 left-1/2 transform -translate-x-1/2 text-3xl font-bold z-10";
//   // scoreBoard.innerText = "0 - 0";
//   // scoreBoard.style.color = '#e0e7ff';
//   // scoreBoard.style.textShadow = '0 0 6px rgba(255,255,255,0.5), 0 0 10px rgba(173,216,230,0.4), 0 0 16px rgba(255,255,200,0.3)';
...
//   // gameFrame.append(scoreBoard, announce);
